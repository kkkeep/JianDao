...
public abstract class BaseRecyclerAdapter2<D1,D2> extends RecyclerView.Adapter<BaseRecyclerAdapter2.BaseAdapterHolder2<D1,D2>> {
    ...
    public  static class BaseAdapterHolder2<D1,D2> extends RecyclerView.ViewHolder {

        private WeakReference<BaseRecyclerAdapter2<D1,D2>> reference;
        ...
        public BaseAdapterHolder2(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    BaseRecyclerAdapter2<D1,D2> adapter2;
        ...
        private void setAdapter(BaseRecyclerAdapter2<D1,D2> adapter) {

            this.reference = new WeakReference<>(adapter);
        }

        public void bindData1(D1 data){

        }
        public void bindData2(D2 data){
